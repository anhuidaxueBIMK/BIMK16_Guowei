function Offspring = P_generatorCW(MatingPool,Boundary,Coding,MaxOffspring,k1,k2,param)
% 交叉,变异并生成新的种群
...
%*******
    ...
    switch Coding
        ...
        case 'Binary'
            %遗传操作参数
            ProM = ones(MaxOffspring,D)*(1/param.FSnumber);	%变异概率
